// Package xpath implements a strict subset of the XPath specification for the Go language.
//
...
//
// At the moment, xpath is compatible with the XPath specification
...
//
//     path := xpath.MustCompile("/library/book/isbn")
//     root, err := xpath.Parse(file)
//     if err != nil {
//             log.Fatal(err)
//     }
